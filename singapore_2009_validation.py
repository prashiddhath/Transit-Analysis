...
AVERAGE_SUBWAY_SPEED_KMH = 35  # Singapore MRT average speed
...
def main():
    ...
    visualize_network_graph(G_fri, stations_df, topology, 
                           os.path.join(OUTPUT_DIR, 'ng_singapore_2009.png'))
    
    # FRI Resilience plots - one for each delta interpretation
    visualize_fri_resilience(scenarios_df, 
                            os.path.join(OUTPUT_DIR, 'fri_transfers_singapore_2009.png'),
                            metric_type='transfers')
    visualize_fri_resilience(scenarios_df, 
                            os.path.join(OUTPUT_DIR, 'fri_trains_singapore_2009.png'),
                            metric_type='trains')
    
    visualize_sme_analysis(sme_df, 
                          os.path.join(OUTPUT_DIR, 'sme_singapore_2009.png'))
    visualize_network_degradation(scenarios_df,
                                  os.path.join(OUTPUT_DIR, 'deg_singapore_2009.png'))
